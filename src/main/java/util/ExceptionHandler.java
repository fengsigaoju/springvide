...
import model.result.BaseResult;
...
public class ExceptionHandler {
     ...
     * @param args
     */
    public static void handleSystemException(Logger LOGGER, BaseResult result, BusinessException ex, String message, Object... args) {
        result.setSuccess(false);
